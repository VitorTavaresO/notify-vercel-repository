...
function AnnouncementList() {
  ...
  const programs = [
    { label: "Todos", value: "Todos", icon: "/images/icon_role0_marked.png" },
    {
      label: "Institucional",
      value: "Institucional",
      icon: "/images/flag_if.png",
    },
    {
      label: "Todos os Cursos",
      value: "Todos os Cursos",
      icon: "/images/flag_todosCursos.png",
    },
    {
      label: "Individual",
      value: "Individual",
      icon: "/images/flag_individual.png",
    },
    {
      label: "Téc. Agroindústria",
      value: "Téc. Agroindústria",
      icon: "/images/flag_agro.png",
    },
    {
      label: "Téc. Informática",
      value: "Téc. Informática",
      icon: "/images/flag_info.png",
    },
    {
      label: "Téc. Mecatrônica",
      value: "Téc. Mecatrônica",
      icon: "/images/flag_meca.png",
    },
  ];
    ...
    ? announcements
        .filter((announcement) => {
          ...
          const matchesProgram =
            ...
            announcement.course.includes(selectedProgram);
          const matchesClass =
            selectedClass === "Todas" ||
            announcement.className.includes(selectedClass);
  ...
  const itemTemplate = (announcement) => {
    ...
    const formattedClasses = announcement.className
      ? formatClasses(announcement.className)
      : "Sem turma definida";
    const courses = announcement.course
      ? announcement.course.join(", ")
      : "Sem curso definido";
    ...
    const renderFlags = (course) => {
      ...
      if (course.includes("Individual")) {
        flags.push(
          <img
            alt="Individual"
            src="/images/flag_individual.png"
            height="35"
            className="icon_role"
          />
        );
    ...
    return (
      <Card className="card-container">
        <div className="icon_role_area">{renderFlags(courses)}</div>
                ...
                {announcement.annexes.map((annex, index) => (
                  <li key={index}>
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://backend-latest-s206.onrender.com/api/messages/${announcement.id}/annexes/${annex.id}/download`,
                          "_blank"
                        )
                      }
                    />
  ...
  const handleNomeEstudanteChange = (value) => {
    if (value != null) {
      ...
      const matchingGuardian = guardiansName.find(
        (guardian) => guardian.studentName === value.label
      );
      ...
      >
        {selectedAnnouncement ? (
          <div>
            ...
            {selectedAnnouncement.annexes &&
              selectedAnnouncement.annexes.length > 0 && (
                <div className="announcement-attachments">
                    ...
                    {selectedAnnouncement.annexes.map((annex, index) => (
                      <li key={index}>
                        <Button
                          ...
                          onClick={() =>
                            window.open(
                              `https://backend-latest-s206.onrender.com/api/messages/${selectedAnnouncement.id}/annexes/${annex.id}/download`,
                              "_blank"
                            )
                          }
                        />
        ...
        <div className="p-fluid">
            ...
            <>
              ...
              <div className="field">
                ...
                <Dropdown
                  ...
                  value={
                    studentsName.find(
                      (student) => student.label === nomeEstudante
                    ) || nomeEstudante
                  }
              ...
              <div className="field">
                ...
                <Dropdown
                  ...
                  value={
                    guardiansName.find(
                      (guardian) => guardian.label === nomeResponsavel
                    ) || nomeResponsavel
                  }
          ...
          <div className="field">
            ...
            <MultiSelect
              ...
              display="chip"
              disabled={
                selectedPrograms.includes("Institucional") ||
                selectedPrograms.includes("Individual")
              }
            />
          </div>
